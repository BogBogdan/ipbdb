...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.category'
        db.alter_column(u'sources', 'category', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Source.category'
        db.alter_column(u'sources', 'category', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
