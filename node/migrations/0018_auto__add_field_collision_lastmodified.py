...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collision.lastmodified'
        db.add_column(u'collisions', 'lastmodified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2017, 9, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collision.lastmodified'
        db.delete_column(u'collisions', 'lastmodified')
    ...
    models = {
        ...
        'node.collision': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 9, 19, 0, 0)'}),
        ...
        'node.source': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'default': "'journal'", 'max_length': '32'}),
        ...
        'node.species': {
            ...
            'ion_charge': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'stoichiometric_formula': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'})
        },
        'node.speciesstate': {
