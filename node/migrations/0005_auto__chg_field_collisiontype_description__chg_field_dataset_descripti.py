...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CollisionType.description'
        db.alter_column(u'collisiontypes', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DataSet.description'
        db.alter_column(u'datasets', 'description', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'CollisionType.description'
        db.alter_column(u'collisiontypes', 'description', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'DataSet.description'
        db.alter_column(u'datasets', 'description', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
