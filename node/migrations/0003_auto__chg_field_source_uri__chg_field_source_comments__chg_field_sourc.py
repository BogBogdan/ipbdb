...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sources', 'uri', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Source.comments'
        db.alter_column(u'sources', 'comments', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Source.bibtex'
        db.alter_column(u'sources', 'bibtex', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Source.source_name'
        db.alter_column(u'sources', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Changing field 'Source.uri'
        db.alter_column(u'sources', 'uri', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Source.comments'
        db.alter_column(u'sources', 'comments', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Source.bibtex'
        db.alter_column(u'sources', 'bibtex', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Source.source_name'
        db.alter_column(u'sources', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
