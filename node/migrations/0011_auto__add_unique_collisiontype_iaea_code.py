...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CollisionType', fields ['iaea_code']
        db.create_unique(u'collisiontypes', ['iaea_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'CollisionType', fields ['iaea_code']
        db.delete_unique(u'collisiontypes', ['iaea_code'])
