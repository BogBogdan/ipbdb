...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SpeciesState.treshold_unit'
        db.add_column(u'speciesstates', 'treshold_unit', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'SpeciesState.description'
        db.add_column(u'speciesstates', 'description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Changing field 'SpeciesState.configuration'
        db.alter_column(u'speciesstates', 'configuration', self.gf('django.db.models.fields.CharField')(max_length=512))


    def backwards(self, orm):
        
        # Deleting field 'SpeciesState.treshold_unit'
        db.delete_column(u'speciesstates', 'treshold_unit')

        # Deleting field 'SpeciesState.description'
        db.delete_column(u'speciesstates', 'description')

        # Changing field 'SpeciesState.configuration'
        db.alter_column(u'speciesstates', 'configuration', self.gf('django.db.models.fields.CharField')(max_length=128))
