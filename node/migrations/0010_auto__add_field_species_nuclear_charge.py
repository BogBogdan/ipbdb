...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Species.nuclear_charge'
        db.add_column(u'species', 'nuclear_charge', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Species.nuclear_charge'
        db.delete_column(u'species', 'nuclear_charge')
