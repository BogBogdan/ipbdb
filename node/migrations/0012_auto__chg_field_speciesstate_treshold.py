...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpeciesState.treshold'
        db.alter_column(u'speciesstates', 'treshold', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'SpeciesState.treshold'
        db.alter_column(u'speciesstates', 'treshold', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
