...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Source.bibtex'
        db.alter_column(u'sources', 'bibtex', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    models = {
        ...
        'node.source': {
            ...
            'bibtex': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
