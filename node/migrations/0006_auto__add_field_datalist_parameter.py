...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataList.parameter'
        db.add_column(u'datalists', 'parameter', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataList.parameter'
        db.delete_column(u'datalists', 'parameter')
