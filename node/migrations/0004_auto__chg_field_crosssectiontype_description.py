...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CrossSectionType.description'
        db.alter_column(u'crosssectiontypes', 'description', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'CrossSectionType.description'
        db.alter_column(u'crosssectiontypes', 'description', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
