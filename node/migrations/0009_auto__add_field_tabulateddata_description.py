...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TabulatedData.description'
        db.add_column(u'tabulateddata', 'description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TabulatedData.description'
        db.delete_column(u'tabulateddata', 'description')
