...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.stoichiometric_formula'
        db.add_column(u'species', 'stoichiometric_formula',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Species.molecular_weight'
        db.add_column(u'species', 'molecular_weight',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.stoichiometric_formula'
        db.delete_column(u'species', 'stoichiometric_formula')

        # Deleting field 'Species.molecular_weight'
        db.delete_column(u'species', 'molecular_weight')
    ...
    models = {
        ...
        'node.species': {
            ...
            'molecular_weight': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
