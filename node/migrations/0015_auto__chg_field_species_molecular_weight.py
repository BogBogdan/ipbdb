...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Species.molecular_weight'
        db.alter_column(u'species', 'molecular_weight', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Species.molecular_weight'
        db.alter_column(u'species', 'molecular_weight', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
